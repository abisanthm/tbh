...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/products/stock-history-list', [ProductController::class, 'productStockHistoryGroup']);
    ...
    Route::get('/products/list-with-filter', [ProductController::class, 'getProductsWithFilter']);
    ...
    Route::get('/products/sale-list', [ProductController::class, 'listProducts'])->name('products.selist');
    ...
    Route::get('/sells/cake-orders', [SellController::class, 'indexOrder']);
