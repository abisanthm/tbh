            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="display: none">
                    <div class="form-group">
                        ...
                        <select class="form-control valid" required="" id="invoice_scheme_id" name="invoice_scheme_id" aria-required="true" aria-invalid="false"><option value="">Please Select</option><option value="1" selected="selected">Default</option></select>
                    </div>
                </div>
                ...
                <div class="col-sm-6" style="display: none">
                    <div class="form-group">
                        ...
                        <select class="form-control valid" required="" id="sale_invoice_scheme_id" name="sale_invoice_scheme_id" aria-required="true" aria-invalid="false"><option  value="">Please Select</option><option value="1" selected="selected">Default</option></select>
                    </div>
                </div>
                ...
                <div class="col-sm-6" style="display: none">
                    <div class="form-group">
                        ...
                        <select class="form-control valid" required="" id="invoice_layout_id" name="invoice_layout_id" aria-required="true" aria-invalid="false"><option  value="">Please Select</option><option value="1" selected="selected">Default</option></select>
                    </div>
                </div>
                <div class="col-sm-6" style="display: none">
                    <div class="form-group">
                        ...
                        <select class="form-control valid" required="" id="sale_invoice_layout_id" name="sale_invoice_layout_id" aria-required="true" aria-invalid="false"><option value="">Please Select</option><option value="1" selected="selected">Default</option></select>
