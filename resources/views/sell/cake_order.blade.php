...
@section('content')
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <!-- Add this input element in your HTML to filter by product ID -->
<div class="col-md-3">
    <div class="form-group">
        <label for="sell_list_filter_product_id">Product ID:</label>
        <input type="text" id="sell_list_filter_product_id" class="form-control" placeholder="Enter Product ID">
    </div>
</div>
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('All cake orders')])
            ...
            @if (auth()->user()->can('direct_sell.view') ||
                ...
                @endphp
                <table class="table table-bordered table-striped ajax_view compact" id="sell_table">
                    <thead>
                        <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        sell_table = $('#sell_table').DataTable({
            ...
            "ajax": {
                ...
                "data": function(d) {
                    ...
                    // Get the product ID filter value
                    if ($('#sell_list_filter_product_id').val()) {
                        d.product_id = $('#sell_list_filter_product_id').val();
                    }
        ...
        $(document).on('change',
            '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs, #shipping_status, #sell_list_filter_source, #payment_method, #sell_list_filter_product_id',
            function() {
                sell_table.ajax.reload();
            });
