                        ...
                        if (! empty($new_purchase_lines)) {
                            foreach ($new_purchase_lines as $key => $new_purchase_line) {
                                ...
                                DB::table('variations')
                                    ...
                                    ->update(['sell_price_inc_tax' => $new_purchase_line->purchase_price_inc_tax,
                                    'default_sell_price' => $new_purchase_line->purchase_price_inc_tax,
                                    'dpp_inc_tax' => $new_purchase_line->purchase_price_inc_tax,
                                    'default_purchase_price'=>$new_purchase_line->purchase_price_inc_tax 
                                ]);
