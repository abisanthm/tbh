            ...
            return Datatables::of($query)
                ->editColumn('product_name', function ($row) {
                 ...
                 ->editColumn('ref_no', function ($row) {
                    $product_name = $row->product_name;
                    $id = $row->product_id;
                    $product_link = action([\App\Http\Controllers\ProductController::class, 'productStockHistory'], [$id]);

                     return '<a data-href="'.action([\App\Http\Controllers\PurchaseController::class, 'show'], [$row->transaction_id])
                            .'" href="#" data-container=".view_modal" class="btn-modal">Purchase View</a><br><a href="'.$product_link.'">Product View</a>';
                 })
